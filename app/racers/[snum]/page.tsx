  ...
  return (
    <main className="flex-1 px-4 py-4 max-w-lg mx-auto w-full">
      ...
      <div className="flex items-center justify-between mb-1">
        <h1 className="text-lg font-bold dark:text-gray-100">{racer.name}</h1>
          ...
          <button
            ...
            className={`text-xs font-semibold px-3 py-1.5 rounded-full active:opacity-70 ${
              isFavorite
                ...
                : "bg-white border border-gray-300 text-gray-500 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400"
            }`}
          >
      ...
      <section className="bg-white rounded-lg shadow-sm p-4 mb-4 dark:bg-gray-800">
        <h2 className="font-semibold mb-2 text-sm text-gray-600 dark:text-gray-300">通算成績</h2>
      ...
      <section className="bg-white rounded-lg shadow-sm p-4 dark:bg-gray-800">
        ...
        {history.length === 0 ? (
          ...
          <ul className="divide-y divide-gray-100 text-sm dark:divide-gray-700">
            {history.map((h) => (
              <li key={`${h.race_date}_${h.venue_abbr}`} className="flex justify-between py-1.5 dark:text-gray-200">
                <span className="text-gray-500 dark:text-gray-400">{h.race_date}</span>
